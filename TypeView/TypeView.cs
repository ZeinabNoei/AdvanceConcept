    ...
    internal class Program
    {
        ...
        private static void AnalyzeType(Type t)
        {
            ...
            foreach (MemberInfo NextMember in Members)
            {
                ...
                //if (NextMember.MemberType == MemberTypes.Method)
                //{
                //    MethodInfo methodInfo = t.GetMethod(NextMember.Name);
                //    Console.WriteLine(NextMember.Name + "\t" + "Signature: " + t.GetMethod(NextMember.Name));
                //}
            }
        }
