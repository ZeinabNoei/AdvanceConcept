...
{
   public class ContactsRepository : IContanctsRepository
    {
        private string connectionString = @"Data Source=CENTER-SER\SQLSERVER2008;Initial Catalog=MvcShop;Integrated Security=true";
