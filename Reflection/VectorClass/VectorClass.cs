...
namespace VectorClass
{
    ...
    [LastModifiedAttribute("10 Feb 2010", "IFormattable interface implemented " +
                                 "So Vector now responds to format specifiers N and VE" ,Issues ="ssd" )]

    internal class Vector : IFormattable, IEnumerable
    {
